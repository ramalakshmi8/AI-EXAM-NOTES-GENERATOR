  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 px-6 py-8">
      ...
      >
        ...
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <button
            ...
            className="px-4 py-3 rounded-full text-sm font-medium bg-white/10
          border border-white/20 text-white hover:bg-white/20 transition flex items-center gap-2"
          >
            Your Notes
          </button>
        </div>
      ...
      {loading && (
        ...
        >
          Generating your exam-focused notes....
        </motion.div>
      )}
      {error && (
        <motion.div className="mb-6 text-center text-red-600 font-medium">
          {error}
        </motion.div>
      )}
      ...
      backdrop-blur-lg border border-dashed border-gray-300 text-gray-500 shadow-inner"
        >
          ...
          <p className="text-sm">💎Generated will appear here.</p>
        </motion.div>
      )}
