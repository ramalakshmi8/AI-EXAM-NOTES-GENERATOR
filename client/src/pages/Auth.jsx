    ...
    <div className="min-h-screen overflow-hidden bg-white text-black px-8">
      ...
      <main className="max-w-7xl mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        shadow-[0_25px_60px_rgba(0,0,0,0.7)]"
          ...
          <p className="mt-6 max-w-xl text-1g bg-gradient-to-br from-gray-700 via-gray-500/80 to-gray-700 bg-clip-text text-transparent">
            You get <span className="font-semibold">50 FREE credits</span>to
            create exam notes.project notes,charts and download clean
